...
return [
    'components' => [
        ...
        'messageQueue' => [
            ...
            'exchangeName' => 'xianzhi.message.test.exchange',
            'queueName' => 'xianzhi.message.test.queue',
        ...
        'rewardPointQueue' => [
            ...
            'user' => 'root',
            'password' => 'pfWL4jkwvDhGyKiY',
            'exchangeName' => 'xianzhi.reward_point.test.exchange',
            'queueName' => 'xianzhi.reward_point.test.queue',
            'serializer' => '\yii\queue\serializers\JsonSerializer'
        ],
